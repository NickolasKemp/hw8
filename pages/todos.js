        ...
        <section class="text-gray-600 body-font">
            <div class="container px-5 py-24 mx-auto">
                ...
                <div class="flex flex-wrap -m-4">
                    ...
                    {todos.map(item => {
                        return <div class=" items-center justify-between gap-4 mb-3 rounded-2xl bg-blue-100 p-3 w-full">
                            <div class="h-full  flex-col items-center text-center">
                                <div class=" flex gap-5 justify-between">
                                    <div class="flex flex-col items-start " >
                                        <h2 class="title-font font-medium text-lg text-gray-900">{item.title}</h2>
                                        <p class="mb-4 text-xs">{item.desc}</p>
                                    </div>
                                    <span class="inline-flex gap-5 items-center ">
                                        <a class="text-gray-500 cursor-pointer inline-block" onClick={() => { deleteTodo(item.title) }}>
